                    ...
                    <div className="flex items-center gap-1">
                        <div className="flex items-center">
                            ...
                            <img
                                ...
                                src="https://cdn2.iconfinder.com/data/icons/xomo-basics/128/document-03-1024.png"
                                alt=""
                            />
                            {/* </Popover.Button> */}
                        ...
                        <div className="flex flex-1 md:flex-initial items-center">
                            <h1 className="text-xl sm:text-2xl font-bold tracking-tighter font-mono text-gray-700 sm:text-center">
                                Todo List
                            </h1>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center divide-x">
                        ...
                        <div className="inline-flex">
                            <a
                                ...
                                target="_blank"
                                className="inline-flex ml-3 md:ml-5 items-center text-gray-500 hover:text-gray-700"
                            >
